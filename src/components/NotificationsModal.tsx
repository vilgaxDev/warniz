          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-[11px] uppercase tracking-wider font-bold ${
                unreadCount > 0 ? 'text-emerald-500' : isDark ? 'text-slate-400' : 'text-slate-500'
              }`}>
            ...
            {unreadCount > 0 && (
              <button
                ...
                className={`flex items-center gap-1 px-2.5 py-1.5 rounded-xl border text-xs font-bold transition-all cursor-pointer shadow-xs ${
                  isDark
                    ? 'border-[#222C3E] text-slate-300 bg-[#182030] hover:text-white hover:border-emerald-500/40'
        ...
        <div className={`flex items-center justify-between py-3 border-b text-xs font-bold ${
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-xl border text-[11px] font-extrabold flex items-center gap-1.5 cursor-pointer transition-all shadow-xs ${
              isDark
                ? 'bg-[#182030] border-emerald-500/40 text-emerald-400 hover:bg-emerald-600 hover:text-white'
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-2xl border transition-all cursor-pointer flex items-start justify-between gap-3 relative group ${
                    isUnread
                      ? isDark
                        ? 'bg-[#182030] border-emerald-500/40 text-white shadow-md'
                ...
                >
                  <div className="flex items-start gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {isUnread && (
                          <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0 ring-2 ring-emerald-500/30 animate-pulse" />
                        )}
                      </div>
                  ...
                  {isUnread && (
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-emerald-500/15 text-emerald-500 border border-emerald-500/30 shrink-0">
                      NEW
                    </span>
                  )}
                </div>
